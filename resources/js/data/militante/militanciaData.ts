...
// Función helper para obtener militancia
export const getMilitantBySlug = (slug: string): Militant | undefined => {
    return militanciaData.find(militante => militante.slug === slug);
};

// Función para obtener todos los militantes
export const getAllMilitants = (): Militant[] => {
    return militanciaData;
};
